...
We define to be a permutation of the first natural numbers in the range . Let denote the value at position in permutation using
...
Given
and , print the lexicographically smallest absolute permutation
...
Returns
    ...
    int[n]: the lexicographically smallest permutation, or 
